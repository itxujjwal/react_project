...
const Contact = () => {
  ...
  const formDataSave = (e) => {
    e.preventDefault();
    axios
      .post("http://localhost:3004/Contact", data)
      .then((res) => {
        setmessage("Record send it successfuly");
      })
      .catch((err) => {
        seterrMsg("Error");
      });
  ...
  return (
    <div>
      <section class="py-3 py-md-5 py-xl-8">
        ...
        <div class="container" style={{height:'100vh', margin:"0%,10%,0%,10%"}}>
          <div class="row">
            <div class="col-12">
              {message ? (
              ...
              <div class="card border border-dark rounded shadow-sm overflow-hidden">
                <div class="card-body p-0">
                  <div class="row gy-3 gy-md-4 gy-lg-0">
                    <div
                      class="col-12 col-lg-6 bsb-overlay background-position-fill background-size-cover"
                      style={{
                        "--bsb-overlay-opacity": 0.3,
                        backgroundImage:
                          "url(https://png.pngtree.com/thumb_back/fh260/background/20230624/pngtree-online-shopping-in-3d-a-conceptual-illustration-featuring-a-laptop-and-image_3668367.jpg)",
                      ...
                      <div class="row align-items-lg-center justify-content-center h-100">
                        <div class="col-11 col-xl-10">
                          <div class="contact-info-wrapper py-4 py-xl-5">
                            ...
                            <p class="lead fs-4 text-light opacity-75 mb-4 mb-xxl-5">
                            ...
                            <div class="d-flex mb-4 mb-xxl-5">
                              ...
                              <div>
                                ...
                                <address class="mb-0 text-light opacity-75">
                            ...
                            <div class="d-flex">
                              ...
                              <div>
                                ...
                                <div class="d-flex mb-1">
                                  <p class="text-light fw-bold mb-0 me-5">
                                    Mon - Fri
                                  </p>
                    ...
                    <div class="col-12 col-lg-6">
                      <div class="row align-items-lg-center h-100">
                        <div class="col-12">
                          <form action="" method="post" onSubmit={formDataSave}>
